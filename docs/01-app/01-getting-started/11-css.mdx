...
> **Good to know:** Learn more about [using Tailwind CSS with Next.js](/docs/app/guides/tailwind-css). If you need broader browser support, see the [Tailwind CSS v3 setup instructions](/docs/app/guides/tailwind-css#tailwind-css-v3-setup).
