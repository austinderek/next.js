...
[Tailwind CSS](https://tailwindcss.com/) is a utility-first CSS framework that provides low-level utility classes to build custom designs. We recommend Tailwind for styling Next.js applications due to its excellent developer experience, performance benefits, and built-in design system.
...
<details>
<summary>**Tailwind CSS v3 Setup (for broader browser support)**</summary>

If you need to support older browsers or prefer the traditional configuration approach, you can use Tailwind CSS v3:
...
> **Good to know:** Learn more about [using Tailwind CSS with Next.js](/docs/app/guides/tailwind-css).
...
- **Use Tailwind CSS** for most styling needs as it provides excellent performance and developer experience.
