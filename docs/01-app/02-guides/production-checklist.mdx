...
- **[Global 404](/docs/app/api-reference/file-conventions/not-found#global-not-found-js-experimental):** Add `app/global-not-found.tsx` to serve an accessible 404 for unmatched routes across your app.
