...
That `global-not-found.js` bypasses your app's normal rendering means you'll need to import any global styles, fonts, or other dependencies that your 404 page requires.
